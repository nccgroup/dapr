...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/ui/js/index.tsx");
/******/ })
/************************************************************************/
/******/ ({
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.selectEvent = exports.selectProcess = exports.addEvents = exports.addEvent = exports.clearEvents = exports.CLEAR_EVENTS = exports.SELECT_EVENT = exports.ADD_EVENTS = exports.ADD_EVENT = exports.SELECT_PROCESS = void 0;
...
exports.SELECT_PROCESS = "SELECT_PROCESS";
exports.ADD_EVENT = "ADD_EVENT";
exports.ADD_EVENTS = "ADD_EVENTS";
exports.SELECT_EVENT = "SELECT_EVENT";
exports.CLEAR_EVENTS = "CLEAR_EVENTS";
exports.clearEvents = function () { return typesafe_actions_1.action(exports.CLEAR_EVENTS); };
exports.addEvent = function (e) { return typesafe_actions_1.action(exports.ADD_EVENT, e); };
exports.addEvents = function (e) { return typesafe_actions_1.action(exports.ADD_EVENTS, e); };
exports.selectProcess = function (proc) {
    return typesafe_actions_1.action(exports.SELECT_PROCESS, proc);
};
exports.selectEvent = function (i) { return typesafe_actions_1.action(exports.SELECT_EVENT, i); };


/***/ }),

/***/ "./src/ui/js/components/App.tsx":
/*!**************************************!*\
  !*** ./src/ui/js/components/App.tsx ***!
  \**************************************/
/*! no static exports found */
...
__webpack_require__(/*! ../styles/App.css */ "./src/ui/js/styles/App.css");
...
var ProcessSelector_1 = __webpack_require__(/*! ./ProcessSelector */ "./src/ui/js/components/ProcessSelector.tsx");
var event_table_1 = __webpack_require__(/*! ../containers/event-table */ "./src/ui/js/containers/event-table.ts");
var App = function () {
    return (React.createElement("div", { className: "root" },
        React.createElement("div", { className: "sidebar" },
            React.createElement("ul", { className: "sidebarFeatures" },
                React.createElement("li", null, "Proxy"),
                React.createElement("li", null, "Repeater"),
                React.createElement("li", null, "Structs")),
            React.createElement("ul", { className: "sidebarPreferences" },
                React.createElement("li", null, "Settings"))),
        React.createElement("div", { className: "dataTable" },
            React.createElement(ProcessSelector_1.default, { clearTableData: function () { return console.log("clearing data"); } }),
            React.createElement("textarea", null),
            React.createElement(event_table_1.EventsTable, null)),
        React.createElement("div", { className: "detailsViews" },
            React.createElement("div", { className: "hexViewer" }, "hex viewer"),
            React.createElement("div", { className: "structDetails" },
                React.createElement("div", { className: "structViewer" }, "struct viewer"),
                React.createElement("div", { className: "structEditor" }, "struct editor")))));
};
exports.default = App;
...
/***/ "./src/ui/js/components/ProcessSelector.tsx":
/*!**************************************************!*\
  !*** ./src/ui/js/components/ProcessSelector.tsx ***!
  \**************************************************/
/*! no static exports found */
...
var api_1 = __webpack_require__(/*! ../utils/api */ "./src/ui/js/utils/api.ts");
var ProcessSelector = function (props) {
    var _a = React.useState(""), proc = _a[0], setProc = _a[1];
    var _b = React.useState([]), procs = _b[0], setProcs = _b[1];
    var _c = React.useState(false), refresh = _c[0], setRefresh = _c[1];
    var onProcChange = function (e) { return __awaiter(void 0, void 0, void 0, function () {
        var c, splits, first, procNum;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    setProc(c);
                    splits = _.split(c, " - ");
                    first = _.first(splits);
                    if (!first) {
                        return [2 /*return*/];
                    }
                    procNum = _.parseInt(first);
                    return [4 /*yield*/, api_1.install(procNum)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    var onRefresh = function (_) { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
        return [2 /*return*/, setRefresh(!refresh)];
    }); }); };
    var onDisconnect = function (__) { return __awaiter(void 0, void 0, void 0, function () {
        var procNum;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!proc) return [3 /*break*/, 2];
                    procNum = _.first(_.split(proc, " - "));
                    if (!procNum) {
                        return [2 /*return*/];
                    }
                    return [4 /*yield*/, api_1.uninstall(procNum)];
                case 1:
                    _a.sent();
    ...
    React.useEffect(function () {
        ...
        var procNum = _.first(_.split(proc, " - "));
        if (!procNum) {
            return;
        }
        api_1.uninstall(procNum);
        api_1.fetchCurrentProcesses().then(function (procs) { return setProcs(procs); });
    }, [refresh]);
    return (React.createElement("div", null,
        React.createElement("button", { onClick: onRefresh }, "Refresh"),
        React.createElement("select", { value: proc, onChange: onProcChange }, _.map(procs, function (value) { return (React.createElement("option", { key: value.pid },
            value.pid,
            " - ",
            value.name)); }))));
};
exports.default = ProcessSelector;


/***/ }),

/***/ "./src/ui/js/components/event-table.tsx":
/*!**********************************************!*\
  !*** ./src/ui/js/components/event-table.tsx ***!
  \**********************************************/
/*! no static exports found */
...
var useWebsocket_1 = __webpack_require__(/*! ./useWebsocket */ "./src/ui/js/components/useWebsocket.tsx");
var columns = ["type", "syscall", "fd", "request"];
var tableColumns = lodash_1.map(columns, function (c) { return React.createElement("th", { key: c }, c); });
exports.EventsTable = function (props) {
    useWebsocket_1.useWebSocket("ws://localhost:8888", {
        onMessage: function (e) {
            console.log("onmessage", e);
            props.addEvent(e);
        },
        onClose: function () { return console.log("onclose"); },
        onError: function () { return console.log("onerror"); }
    });
    var rows = lodash_1.map(props.events, function (e, i) { return (React.createElement("tr", { key: i }, lodash_1.map(columns, function (c) { return React.createElement("td", { key: c }, e[c]); }))); });
    console.log("rows", rows);
    return (React.createElement("table", null,
        React.createElement("thead", null,
            React.createElement("tr", null, tableColumns)),
...
/***/ "./src/ui/js/components/useWebsocket.tsx":
/*!***********************************************!*\
  !*** ./src/ui/js/components/useWebsocket.tsx ***!
  \***********************************************/
/*! no static exports found */
...
var App_1 = __webpack_require__(/*! ../components/App */ "./src/ui/js/components/App.tsx");
...
/***/ "./src/ui/js/containers/event-table.ts":
/*!*********************************************!*\
  !*** ./src/ui/js/containers/event-table.ts ***!
  \*********************************************/
/*! no static exports found */
...
exports.EventsTable = void 0;
var react_redux_1 = __webpack_require__(/*! react-redux */ "./node_modules/react-redux/es/index.js");
var event_table_1 = __webpack_require__(/*! ../components/event-table */ "./src/ui/js/components/event-table.tsx");
var actions_1 = __webpack_require__(/*! ../actions/actions */ "./src/ui/js/actions/actions.ts");
var mapStateToProps = function (state) { return ({
    events: state.events,
...
var mapDispatchToProps = function (dispatch) { return ({
    selectEvent: function (e) { return dispatch(actions_1.selectEvent(e)); },
    addEvent: function (e) { return dispatch(actions_1.addEvent(e)); }
}); };
exports.EventsTable = react_redux_1.connect(mapStateToProps, mapDispatchToProps)(event_table_1.EventsTable);
...
var react_redux_1 = __webpack_require__(/*! react-redux */ "./node_modules/react-redux/es/index.js");
__webpack_require__(/*! ./styles/index.css */ "./src/ui/js/styles/index.css");
var App_1 = __webpack_require__(/*! ./containers/App */ "./src/ui/js/containers/App.ts");
var root_reducer_1 = __webpack_require__(/*! ./reducers/root-reducer */ "./src/ui/js/reducers/root-reducer.ts");
...
/***/ "./src/ui/js/reducers/events-reducer.ts":
/*!**********************************************!*\
  !*** ./src/ui/js/reducers/events-reducer.ts ***!
  \**********************************************/
/*! no static exports found */
...
var driverTableActions = __webpack_require__(/*! ../actions/actions */ "./src/ui/js/actions/actions.ts");
var defaultState = {
    events: [],
    selectedEventID: -1,
...
/***/ "./src/ui/js/reducers/root-reducer.ts":
/*!********************************************!*\
  !*** ./src/ui/js/reducers/root-reducer.ts ***!
  \********************************************/
/*! no static exports found */
...
var events_reducer_1 = __webpack_require__(/*! ./events-reducer */ "./src/ui/js/reducers/events-reducer.ts");
var redux_1 = __webpack_require__(/*! redux */ "./node_modules/redux/es/redux.js");
exports.rootReducer = redux_1.combineReducers({ eventsReducer: events_reducer_1.eventsReducer });


/***/ }),

/***/ "./src/ui/js/styles/App.css":
/*!**********************************!*\
  !*** ./src/ui/js/styles/App.css ***!
  \**********************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.daprTokenName = exports.fetchCurrentProcesses = exports.install = exports.uninstall = void 0;
exports.uninstall = function (pid) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, authedFetch("http://localhost:8888/session/uninstall", {
                    method: "POST",
...
exports.install = function (pid) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, authedFetch("http://localhost:8888/session/install", {
                    method: "POST",
...
exports.fetchCurrentProcesses = function () { return __awaiter(void 0, void 0, void 0, function () {
    var respJSON;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, authedFetch("http://localhost:8888/procs")];
            case 1:
                respJSON = _a.sent();
                return [4 /*yield*/, respJSON.json()];
            case 2: return [2 /*return*/, _a.sent()];
        }
    });
}); };
exports.daprTokenName = "dapr";
var auth = function () { return __awaiter(void 0, void 0, void 0, function () {
    var password, tokenJSON, token;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                password = prompt("What's the password");
                return [4 /*yield*/, jsonFetch("http://localhost:8888/auth", {
                        method: "POST",
...
var getAuthToken = function () { return localStorage.getItem(exports.daprTokenName) || ""; };
var jsonFetch = function (url, opts) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, fetch(url, Object.assign({ headers: { "Content-Type": "application/json" } }, opts))];
            case 1: return [2 /*return*/, _a.sent()];
        }
    });
}); };
var authedFetch = function (url, opts) { return __awaiter(void 0, void 0, void 0, function () {
    var token;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                if (!!(token = getAuthToken())) return [3 /*break*/, 2];
                return [4 /*yield*/, auth()];
            case 1:
                token = _b.sent();
                if (!token) {
                ...
                localStorage.setItem(exports.daprTokenName, token);
                return [3 /*break*/, 2];
            case 2: return [4 /*yield*/, jsonFetch(url, Object.assign({}, {
                    headers: (_a = {},
                        _a[exports.daprTokenName] = token,
                        _a)
                }, opts))];
